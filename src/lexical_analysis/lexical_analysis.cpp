...
void lexical_analysis::printToken(Token &token) {
    switch (token.type) {
        case TokenType::tok_identifier:
            std::cout << token.identifier_str << std::endl;
            break;
        ...
        case TokenType::tok_number:
            std::cout << token.num_val << std::endl;
            break;
        case TokenType::tok_empty:
            break;
